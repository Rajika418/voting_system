...
function renderNominationData(nomination) {
    ...
    nominationInfo.innerHTML = `
        ...
        <p><strong>Nomination Start Date:</strong> ${new Date(nomination.start_date).toLocaleDateString()}</p>
        <p><strong>Nomination End Date:</strong> ${new Date(nomination.end_date).toLocaleDateString()}</p>
