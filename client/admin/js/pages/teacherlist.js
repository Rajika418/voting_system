...
function fetchTeachers() {
  ...
  fetch(
    `http://localhost/voting_system/server/controller/teacher/teacher_get.php?page=${currentPage}&search=${searchQuery}&results_per_page=${resultsPerPage}&sort_order=${sortOrder}`
  )
...
function openPopup(row) {
  ...
  document.getElementById("editJoinDate").value =
    cells[8].innerText !== "-" ? cells[8].innerText : "";
  document.getElementById("editLeaveDate").value =
    cells[9].innerText !== "-" ? cells[9].innerText : "";
